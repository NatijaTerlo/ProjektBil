...
public class CarController {
  ...
  /*  @PostMapping("/register_car")
    public String registerCar(@ModelAttribute("car") Car car, RedirectAttributes redirectAttributes) {
        if (car != null) {
            if (!car.isRegistered()) {
                carService.registerCar(car);
                redirectAttributes.addFlashAttribute("successMessage", "The car has been registered successfully!");
            } else {
                redirectAttributes.addFlashAttribute("errorMessage", "The car is already registered");
            }
        } else {
